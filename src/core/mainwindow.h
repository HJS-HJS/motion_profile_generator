...
protected:
    // Override showEvent to apply initial view settings
...
private:
    ...
    QDoubleSpinBox* m_refYSpin; // Y Scale Reference
    QDoubleSpinBox* m_gridXSpin; // X Grid Size
    QDoubleSpinBox* m_gridLargeXSpin; // X Major Grid Size
    QPushButton* m_applyViewButton; // Renamed button
    // X Range spins removed
